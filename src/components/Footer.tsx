...
Jl. Taman Mutiara Palem, Cengkareng, Jakarta Barat 11730</p>
        ...
        <div className="flex flex-col items-center md:items-end gap-6">
          ...
          <a
            ...
            aria-label="Facebook"
            className="text-white hover:text-amber-200 transition-all duration-300 hover:-translate-y-1"
          >
      ...
      <div className="text-center">
        <p className="text-amber-200/60">
          &copy; {new Date().getFullYear()} Gereja Rasuli Indonesia Jemaat Zion Filadelfia. All rights reserved.
        </p>
      </div>
    </footer>
  );
